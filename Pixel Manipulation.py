...
# Buttons in GUI 
B1 = Button(root, text="Encrypt" , command=encrypt_image, borderwidth=1.5, relief="solid")
B1.place(x=50,y=10)

B2 = Button(root , text="Decrypt", command=decrypt_image, borderwidth=1.5, relief="solid")
B2.place(x=245,y=10)
# TextBox parameters
Choice = Text(root , height=3 , width=30, borderwidth=1.5, relief="solid")
